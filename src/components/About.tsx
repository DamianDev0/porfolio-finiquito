...
const About = () => {
  return (
    ...
    >
      <div
        className="w-full max-w-[calc(100%-15px)] pt-12 pb-0 min-[768px]:w-[500px] min-[768px]:max-w-[calc(100%-70px)] min-[1025px]:w-1/2 min-[1025px]:py-0 min-[1025px]:pt-0 min-[1950px]:max-w-full"
        data-section-item
      >
        <h3 className="title text-[25px] font-normal uppercase tracking-[7px] text-[var(--accentColor)]" data-section-item>
          About Me
        </h3>
        <p

...
const Contact = () => {
  return (
    <div
      ...
      data-section
    >
      <div className="w-full max-[900px]:w-[calc(100%-25px)]" data-section-item>
        <h3 className="title m-0 text-[60px] font-normal uppercase max-[1600px]:text-[50px] max-[1300px]:text-[40px]" data-section-item>
          Contact
        </h3>
        <div className="mt-10 flex justify-between gap-16 max-[900px]:mt-6 max-[900px]:flex-col" data-section-item>
          <div className="flex flex-col" data-section-item>
